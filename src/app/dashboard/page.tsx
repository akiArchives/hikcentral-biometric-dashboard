...
import { CalendarCheck2, UserRoundX, ClockAlert, Users } from "lucide-react";

export default function EmployeesPage() {
  return (
    <div className="size-full my-5 px-4 flex flex-col gap-6">
      ...
      <div className="flex flex-row gap-6">
        ...
        <Card className="rounded-md w-full">
          ...
          <CardContent className="">
            <p className="font-bold text-3xl text-gray-700">6</p>
          </CardContent>
        </Card>
      ...
      <div className="h-full">
        <Card className="rounded-md w-full h-full">
          <CardHeader className=" text-gray-600">
